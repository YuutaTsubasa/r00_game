    ...
    let mut scene = GamePlayScene::new(
        vec![
            AvgItem {
                ...
                left_character_image_path: Some("./resources/images/characters/Yuuta1/sad.png".to_string()),
            ...
            AvgItem {
                ...
                left_character_image_path: Some("./resources/images/characters/Yuuta1/normal.png".to_string()),
                character_name: Some("悠太翼".to_string()),
            ...
            AvgItem {
                background_music: None,
                background_image_path: None,
                left_character_image_path: None,
                character_name: Some("悠太翼".to_string()),
                content: Some("而且還在建置成 Standalone 和 Web 的 Build！".to_string()),
            },
            AvgItem {
                background_music: None,
                background_image_path: None,
                left_character_image_path: Some("./resources/images/characters/Yuuta1/happy.png".to_string()),
                character_name: Some("悠太翼".to_string()),
